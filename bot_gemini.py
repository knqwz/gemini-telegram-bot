...
def kiem_tra_trang_thai_may_chu():
    return "Raphael Bot dang van hanh 24/7 tren mo hinh gemini-3.6-flash."
...
def gui_loi_chao_khoi_dong(tin_nhan_den_tu_nguoi_dung):
    trung_tam_dieu_khien_bot.reply_to(tin_nhan_den_tu_nguoi_dung, "《Thông báo》 Raphael đã kích hoạt thành công trên mô hình gemini-3.6-flash tại máy chủ Render. Raphael sẵn sàng nhận lệnh từ Ngài.")
...
def xu_ly_va_truy_van_gemini(tin_nhan_den_tu_nguoi_dung):
    try:
        ...
        chuoi_thong_bao_loi = "《Cảnh báo》 Sự cố xử lý: " + str(loi_phat_sinh_he_thong)
        trung_tam_dieu_khien_bot.reply_to(tin_nhan_den_tu_nguoi_dung, chuoi_thong_bao_loi)
...
if __name__ == "__main__":
    ...
    trung_tam_dieu_khien_bot.infinity_polling()    "top_k": 1,
    "max_output_tokens": 2048,
}
